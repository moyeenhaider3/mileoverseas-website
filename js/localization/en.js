const enTranslations = {
  ...
  products_hero_subheadline:
    "Discover our range of high-quality spices and ingredients",
  // Navigation
  nav_home: "Home",
  nav_about: "About Us",
  ...
  chat_send: "Send",
  chat_lead_prompt: "Share your email & product to get a detailed quote:",
  chat_lead_email_placeholder: "Your email",
  chat_lead_product_placeholder: "Product / Volume (optional)",
  chat_lead_submit: "Submit",
  chat_lead_cancel: "Cancel",
  chat_lead_invalid_email: "Enter valid email",
  chat_lead_success:
  ...
  chat_user_submitted_quote: "Submitted quote request.",
  ...
  chat_fallback_keywords_prefix: " (Keywords detected: ",
  ...
  chat_fact_list:
    "Turmeric’s curcumin content is a key quality marker and we source high-curcumin lots.|Steam sterilization can reduce microbial load for premium spice applications.|Proper container lining reduces moisture ingress, preserving volatile oil content in spices.|Chilli heat is measured in Scoville units – different export markets prefer different ranges.",
  chat_suggestion_shipping: "Shipping times",
  chat_suggestion_moq: "MOQ",
  chat_suggestion_samples: "Samples",
  chat_suggestion_certifications: "Certifications",
  chat_suggestion_pricing: "Pricing",
  chat_suggestion_quote: "Get a Quote",
  // Chat suggestion question texts
